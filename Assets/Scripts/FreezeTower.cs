...
public class FreeezeTower : MonoBehaviour
{
    ...
    void Fire() // делаем выстрел
    {
        ...
        bullet.GetComponent<FreezeBullet>().Damage = Damage; // записываем урон башни в урон снаряда (инициализируем переменную "Damage" скрипта "Bullet")
